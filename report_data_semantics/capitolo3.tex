...
The target variables chosen for this task are \textbf{2/3 dipende se includiamo anche is\_from\_NA}: \texttt{titleType}, \texttt{has\_LowEngagement} \textbf{, and is\_from\_NA}.
