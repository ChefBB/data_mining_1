...
%   \titlespacing*{\chapter}{0pt}{0pt}{20pt} % Reduce space before first chapter title
% }
...
% % Margini (4cm a sx, 2.5cm a dx, 2.5cm in alto, 2.5cm in basso)
% \usepackage[top=2cm, bottom=2.5cm, left=2cm, right=2.5cm, centering]{geometry}
...
\setcounter{page}{1}
\input{capitolo1.tex} %data preparation



\input{capitolo2.tex} %clustering

\input{capitolo3.tex} %classification

\input{capitolo4.tex} %regression

\input{capitolo5.tex} %pattern mining

% \addcontentsline{toc}{chapter}{Conclusioni} % Capitolo non numerato
%\input{conclusioni.tex} non servono le conclusioni
