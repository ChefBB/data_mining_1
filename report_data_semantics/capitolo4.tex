...
\begin{table}[H]
    ...
    \begin{tabular}{lcccccccc}
        ...
        Ridge & 1.760 & 0.126 & 0.007 & 0.253 & 0.357 & 0.006 & 0.334 \\ % alpha=100
        Lasso & 1.924 & 0.100 & 0.007 & 0.259 & 0.342 & 0.006 & 0.376 \\ % alpha=100
        DT & - & - & 0.005 & 0.127 & 0.678 & 0.004 & 0.194 \\ % {'ccp_alpha': 0.07533781852589416, 'criterion': 'friedman_mse', 'max_depth': 18, 'max_leaf_nodes': 12, 'min_impurity_decrease': 0.05584042497358051, 'min_samples_leaf': 10, 'min_samples_split': 20}
        20-NN & - & - & 0.005 & 0.135 & 0.657 & 0.004 & 0.221 \\
        \midrule
        \textbf{Multiple} & & & & & \\
        \midrule
        Linear & - & - & 0.006 & 0.157 & 0.601 & 0.006 & 0.220 \\
        Ridge & - & - & 0.006 & 0.157 & 0.601 & 0.006 & 0.220 \\ % alpha=0.1
        Lasso & - & - & 0.006 & 0.161 & 0.590 & 0.005 & 0.241 \\ % alpha=1
        DT & - & - & 0.004 & 0.085 & 0.784 & 0.004 & 0.196 \\ % ccp_alpha=0.004666566321361543, criterion='poisson', max_depth=16, min_samples_leaf=15, min_samples_split=16
