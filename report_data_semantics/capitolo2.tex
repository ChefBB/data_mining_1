...
\section{Centroid-based methods}\label{sec:centroid_based} %DA AGGIUNGERE SOTTOSEZIONE K-MEANS SE INCLUDIAMO ANCHE BISECTING
...
%The distribution of data points across the four clusters is as follows: \textbf{[Cluster 1: N1 points, Cluster 2: N2 points, Cluster 3: N3 points, Cluster 4: N4 points]}.
\begin{figure}[h]
    \centering
