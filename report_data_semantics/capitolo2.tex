...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/sil_scores_hierarchical_w_outliers.png}
        \caption{Clustering scores with outliers}
        \label{fig:hier_sil_scores_outliers}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/sil_scores_hierarchical_no_outliers.png}
        \caption{Clustering scores without outliers}
        \label{fig:hier_sil_scores_no_outliers}
    \end{subfigure}
    \caption{Silhouette scores for hierarchical clustering with different linkage methods}
    \label{fig:three_subplots}
\end{figure}
